...
def export_json(is_hard_center_scale=False):
...
class ExportSceneParameters(Operator):
    bl_label = "Export Neuralangelo data"
...
class ExportNerfSceneParameters(Operator):
    bl_label = "Export Nerfstudio data"
    bl_idname = "addon.export_nerfstudio_data"
    ...
    def execute(self, context):
        export_json(is_hard_center_scale=True)
        return {'FINISHED'}
...
# --------------------------------------ns-train neuralangelo----------------------------------
#    Panel
# ------------------------------------------------------------------------

class NeuralangeloCustomPanel(bpy.types.Panel):
    bl_category = "myNeuralangelo"
...
class BoundingPanel(NeuralangeloCustomPanel, bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        box.row().operator('addon.export_nerfstudio_data')
